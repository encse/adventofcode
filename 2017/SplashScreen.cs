...
namespace AdventOfCode.Y2017 {
    ...
    class SplashScreenImpl : SplashScreen {
        ...
        public void Show() {
            ...
            Write(0x999999, false, "|O|       \n           |O|  ");
            Write(0xcccccc, false, "Shemetz            | Murray Edwards      ");
            Write(0x999999, false, "|O|       \n           |O|  ");
            Write(0xcccccc, false, "kindermoumoute     | Ji An Yang          ");
            Write(0x999999, false, "|O|       \n           |O|  ");
            Write(0xcccccc, false, "narimiran          | Ben Buchwald        ");
            Write(0x999999, false, "|O|       \n           |O|  ");
            Write(0xcccccc, false, "ncmiller           | Sean Sartell        ");
            Write(0x999999, false, "|O|       \n           ");
            Write(0xcccccc, false, ".-----------------------------------------------.       \n           | ");
            ...
            Write(0xcccccc, false, "| ");
            Write(0xffff66, true, "*");
            Write(0x666666, false, "───────┐o──┴─┤   O├─┘o─┤ 2-├─────────────┐└┐ ");
            Write(0xcccccc, false, "|  19 ");
            Write(0xffff66, false, "**\n           ");
            Write(0xcccccc, false, "| ");
            Write(0x666666, false, "├─────┐o┴─");
            Write(0x990099, false, "┤[]├");
            Write(0x666666, false, "┤   P├────┤ CG├────┬");
            Write(0xffff66, true, "*");
            Write(0x666666, false, "o──────┴─┘ ");
            Write(0xcccccc, false, "|  18 ");
            Write(0xffff66, false, "**\n           ");
            Write(0xcccccc, false, "| ");
            Write(0x666666, false, "└────o└───────┤   R├────┤   ├o");
            Write(0xffff66, true, "*");
            Write(0x666666, false, "─┐=├─────────┐ ");
            ...
            Write(0xffff66, false, "**\n           ");
            Write(0xcccccc, false, "| ");
            Write(0x666666, false, "┌──┤     ├─┐o─┴┤ P ├┐└──────┬──┘o┐└────");
            Write(0xffff66, true, "*");
            Write(0x666666, false, "┌──┘│ ");
            Write(0xcccccc, false, "|  11 ");
            Write(0xffff66, false, "**\n           ");
            Write(0xcccccc, false, "| ");
            Write(0x666666, false, "└──┤ INTE├─┴───┤ R0├┴────o");
            Write(0xffff66, true, "*");
            Write(0x666666, false, "┐└────┴───o┌┘├───┘ ");
            ...
            Write(0xcccccc, false, "| ");
            Write(0xffff66, true, "*");
            Write(0x666666, false, "──┤ RNET├──┬──┤ 23├─────┬┴┴┴┬────────┘o┴───o ");
            Write(0xcccccc, false, "|   9 ");
            Write(0xffff66, false, "**\n           ");
            Write(0xcccccc, false, "| ");
            Write(0x666666, false, "├──┴┬┬┬┬┬┴──┘┌─┤ AG├─────┤   ├──────");
            Write(0xff9900, false, "∧∧∧");
            Write(0x666666, false, "─────");
            Write(0xffff66, true, "* ");
            ...
            Write(0x666666, false, "───");
            Write(0x990099, false, "┤[]├");
            Write(0x666666, false, "──────┤ O1├──┘┌──────────┘ ");
            Write(0xcccccc, false, "|   6 ");
            Write(0xffff66, false, "**\n           ");
            Write(0xcccccc, false, "| ");
            Write(0x666666, false, "└─┴───┘");
            Write(0xffff66, true, "*");
            Write(0x666666, false, "───┘┌────────────┤ T3├──┐└─┐o───");
            Write(0x66ff, false, "|(");
            Write(0x666666, false, "──┐ ");
