...
namespace AdventOfCode.Y2017 {
    ...
    class SplashScreenImpl : AdventOfCode.SplashScreen {
        ...
        public void Show() {
            ...
            Write(ConsoleColor.Yellow, "**\n           ");
            Write(ConsoleColor.Gray, "| ");
            Write(ConsoleColor.DarkGray, "└──────┤   H├┘┌──┐└───┐┌────────o");
            Write(ConsoleColor.Yellow, "*");
            Write(ConsoleColor.DarkGray, "┐└────────┐ ");
            Write(ConsoleColor.Gray, "|  ");
            ...
            Write(ConsoleColor.Yellow, "**\n           ");
            Write(ConsoleColor.Gray, "| ");
            Write(ConsoleColor.DarkGray, "┌───┐┌─┤   C├─┴─o└───┐│└─┐");
            Write(ConsoleColor.Yellow, "*");
            Write(ConsoleColor.DarkGray, "──────┘└─────────┘ ");
            Write(ConsoleColor.Gray, "|  ");
            ...
            Write(ConsoleColor.Yellow, "**\n           ");
            Write(ConsoleColor.Gray, "| ");
            Write(ConsoleColor.DarkGray, "├──┐└┘o┤   F├───────┬┴┴┴┴┤└──");
            Write(ConsoleColor.Green, "|(");
            Write(ConsoleColor.DarkGray, "────┬┴┴┴┬────");
            Write(ConsoleColor.Yellow, "* ");
            Write(ConsoleColor.Gray, "|  ");
            ...
            Write(ConsoleColor.DarkGray, "│┌─┘┌──┴┬┬┬┬┴───────┤    ├──────o");
            Write(ConsoleColor.Yellow, "*");
            Write(ConsoleColor.DarkGray, "─┤ IR├────┤ ");
            Write(ConsoleColor.Gray, "|  ");
            ...
            Write(ConsoleColor.DarkGray, "=└──┴───o");
            Write(ConsoleColor.Yellow, "*");
            Write(ConsoleColor.DarkGray, "┐└──────o┌┤NAND├──────┬┘o┤ NN├────┘ ");
            Write(ConsoleColor.Gray, "|  ");
            Write(ConsoleColor.DarkGray, " 7 ");
            Write(ConsoleColor.Yellow, "**\n           ");
            Write(ConsoleColor.Gray, "| ");
            Write(ConsoleColor.Yellow, "*");
            Write(ConsoleColor.DarkGray, "────────┘│┌───────┘┤GATE├─┐o───┘┌─┤ TE├────┐ ");
            Write(ConsoleColor.Gray, "|  ");
            ...
            Write(ConsoleColor.DarkGray, "└───");
            Write(ConsoleColor.Yellow, "*");
            Write(ConsoleColor.DarkGray, "┌─o┌─┘└────────┴┬┬┬┬┴o└─────┴─┤ ET├──o┌┘ ");
            Write(ConsoleColor.Gray, "|  ");
            ...
            Write(ConsoleColor.Yellow, "**\n           ");
            Write(ConsoleColor.Gray, "| ");
            Write(ConsoleColor.DarkGray, "┌┘└─o│o──────┐└─┘o┬┐o┬───o");
            Write(ConsoleColor.Yellow, "*");
            Write(ConsoleColor.DarkGray, "─────────────┐└──┐ ");
            Write(ConsoleColor.Gray, "|  ");
